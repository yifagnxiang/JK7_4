...
namespace DAL
{
    public partial  class Appointment
    {
        ...
        public bool Exists(int id,string strWhere)
        {
            ...
            strSql.Append(@"Select Count(*) from [Appointment]");
            if(strWhere.Trim () !="")
               { 
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(@"delete [Appointment] where [Id]='" + id + "'");
        ...
        public IList<Model.Appointment> SelectByPaged(int pageIndex,int pageSize,  string strWhere, string orderBy, out int pageCount)
        {
            string sql_count = "select COUNT(*) from [Appointment]";
            ...
            strSql.Append(")as Row, *  from  Appointment");
            ...
            IList<Model.Appointment> list = new List<Model.Appointment>();
        ...
        /// <param name="pageCount">总行数</param>
        /// <returns>根据分页查询的数据</returns>
        public DataSet GetAppointmentList(int pageIndex,int pageSize, string orderBy, string where, out int pageCount)
        {
            SqlParameter count = new SqlParameter();
            count.ParameterName = "@rowcount";
            count.Direction = ParameterDirection.Output;
            ...
            parameters[0].Value = pageIndex;
            parameters[1].Value = pageSize;
            parameters[2].Value = "[Appointment]";
            parameters[3].Value = orderBy;
            parameters[4].Value = where;
            DataSet ds = SqlDataHelper.RunProcedure("Pager", parameters, "Appointment");
        ...
        private void LoadEntityData(ref Model.Appointment  model, DataRow dr)
        {
           if (dr["Id"].ToString() != "") model.Id = int.Parse (dr["Id"].ToString());
           if (dr["JK_Appointment_Number"].ToString() != "") model.JK_Appointment_Number = int.Parse (dr["JK_Appointment_Number"].ToString());
           if (dr["JK_Appointment_Member_id"].ToString() != "") model.JK_Appointment_Member_id = int.Parse (dr["JK_Appointment_Member_id"].ToString());
           if (dr["JK_Appointment_Datetime"].ToString() != "") model.JK_Appointment_Datetime = dr["JK_Appointment_Datetime"].ToString();
        ...
        /// <returns>结果</returns>
        public int Add(Model.Appointment  model)
        {
            int result = 0;
            try
            {
                ...
                SqlParameter[] parameters = new SqlParameter[] {
                    ...
                    new SqlParameter("@jK_Appointment_Member_id", SqlDbType.Int,4),
                ...
                parameters[2].Value = model.JK_Appointment_Member_id;
                parameters[3].Value = model.JK_Appointment_Datetime;
        ...
        public int Update(Model.Appointment  model)
        {
            int res = -2;
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update [Appointment] set "); 
            strSql.Append("[JK_Appointment_Number] = @jK_Appointment_Number , ");
            strSql.Append("[JK_Appointment_Member_id] = @jK_Appointment_Member_id , ");
            ...
            SqlParameter[] parameters =new SqlParameter[]  {
               ...
               parameters[1].Value = model.JK_Appointment_Member_id;
               parameters[2].Value = model.JK_Appointment_Datetime;
